  ...
  return (
    <>
      <LazyDiv className="card invitation">
        ...
        {/* 초대 문구 */}
        <div className="content">그동안은 남자친구, 여자친구였지만</div>
        <div className="content">이제는 공식적으로</div>
        <div className="content">잔소리를 주고 받기로 했습니다.</div>
        <div className="break" />
        <div className="content">친구 같고, 연인 같고,</div>
